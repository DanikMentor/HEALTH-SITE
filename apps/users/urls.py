...
urlpatterns = [
    ...
    path('ai_chat_api/', views.ai_chat_api, name='ai_chat_api'),#this url made by Arsēnijs Kopačs
    path('calory_counter_api/', views.calory_counter_api, name='calory_counter_api'),#this url made by Nikita Kamdevics
    path('dashboard/', views.dashboard_view, name='dashboard') #this url made by Arsēnijs Kopačs
